...
{
    public partial class BoundedPeriodsController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public BoundedPeriodsController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected BoundedPeriodsController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public BoundedPeriodsController Actions { get { return MVC.BoundedPeriods; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "BoundedPeriods";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "BoundedPeriods";
        ...
        {
            public readonly string hotelId = "hotelId";
            public readonly string boundedPeriod = "boundedPeriod";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string EditOrCreate = "~/Views/BoundedPeriods/EditOrCreate.cshtml";
            public readonly string Index = "~/Views/BoundedPeriods/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BoundedPeriodsController : RestTraining.Web.Controllers.BoundedPeriodsController
    {
        public T4MVC_BoundedPeriodsController() : base(Dummy.Instance) { }
        ...
        public override System.Web.Mvc.ActionResult Create(int hotelId, RestTraining.Common.DTO.BoundedPeriodDTO boundedPeriod)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "hotelId", hotelId);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "boundedPeriod", boundedPeriod);
            CreateOverride(callInfo, hotelId, boundedPeriod);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult Edit(int hotelId, RestTraining.Common.DTO.BoundedPeriodDTO boundedPeriod)
        {
            ...
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "hotelId", hotelId);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "boundedPeriod", boundedPeriod);
            EditOverride(callInfo, hotelId, boundedPeriod);
            return callInfo;
        }
