...
namespace RestTraining.Web.Controllers
{
    ...
    public partial class T4MVC_BoundedBookingController : RestTraining.Web.Controllers.BoundedBookingController
    {
        ...
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int hotelId, RestTraining.Common.DTO.BoundedBookingDTO boundedBooking);

        public override System.Web.Mvc.ActionResult Create(int hotelId, RestTraining.Common.DTO.BoundedBookingDTO boundedBooking)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "hotelId", hotelId);
        ...
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int hotelId, RestTraining.Common.DTO.BoundedBookingDTO boundedBooking);

        public override System.Web.Mvc.ActionResult Edit(int hotelId, RestTraining.Common.DTO.BoundedBookingDTO boundedBooking)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "hotelId", hotelId);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "boundedBooking", boundedBooking);
