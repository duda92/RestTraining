...
namespace RestTraining.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : RestTraining.Web.Controllers.AccountController
    {
        ...
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, RestTraining.Web.Models.LoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult Login(RestTraining.Web.Models.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, RestTraining.Web.Models.RegisterModel model);

        public override System.Web.Mvc.ActionResult Register(RestTraining.Web.Models.RegisterModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ChangePasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, RestTraining.Web.Models.ChangePasswordModel model);

        public override System.Web.Mvc.ActionResult ChangePassword(RestTraining.Web.Models.ChangePasswordModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ChangePassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
